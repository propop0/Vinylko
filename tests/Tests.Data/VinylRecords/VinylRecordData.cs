...
{
    public static VinylRecord FirstVinylRecord(Guid artistId)
    {
    ...
    public static VinylRecord SecondVinylRecord(Guid artistId)
    {
        return VinylRecord.New(
    ...
    public static VinylRecord ThirdVinylRecord(Guid artistId)
    {
        return VinylRecord.New(
    ...
    public static VinylRecord CreateVinylRecordWithCustomTitle(string title, Guid artistId)
    {
        return VinylRecord.New(
            id: Guid.NewGuid(),
            title: title,
